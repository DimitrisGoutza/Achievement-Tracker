...
CREATE TABLE `GAME` (
    ...
    `HEADER_IMAGE` varchar(120) NOT NULL,
    `CAPSULE_IMAGE` varchar(120) NOT NULL,
    `CAPSULE_SMALL_IMAGE` varchar(120) NOT NULL,
    `BACKGROUND_IMAGE` varchar(120) NOT NULL,
    `BACKGROUND_RAW_IMAGE` varchar(120) NOT NULL,
