...
public interface GameDAO extends GenericDAO<Game, Long> {
    ...
    List<Game> findOnlyGamesWithHiddenAchievements(String searchTerm, Page page);
    List<Game> findOnlyGamesWithHiddenAchievementsByCategoryId(String searchTerm, List<Long> categoryIds, Page page);
}
